...
**MLE 20**: Take the sum of squares of 20 miss radiuses, multiply by factor shown in Appendix to get estimate of R<sub>90</sub>.
...
|-------------|-------------------------------------|------------------------|---------------------|
| 5x5         |               `r signif(e$hits55)`% | `r signif(e$rmse55,3)` |`r signif(e$mae55,3)`| 
| 2x10 (9)    |                `r signif(e$hits9)`% | `r signif(e$rmse9,3)`  |`r signif(e$mae9,3)` |
| 2x10 (6&9)  |               `r signif(e$hits69)`% | `r signif(e$rmse69,3)` |`r signif(e$mae69,3)`|
| Rayleigh 20 |               `r signif(e$hits20)`% | `r signif(e$rmse20,3)` |`r signif(e$mae20,3)`|
| MLE 20      |              `r signif(e$hitsmle)`% | `r signif(e$rmsemle,3)`|`r signif(e$maemle,3)`|
