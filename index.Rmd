...
experiment <- function(main=NA, ymax=3, yoffset=0, eccentricity=0, flier_rate=0, flier_severity=3, legendpos='topright', simulated=T)
{
  ...
  mae55 <- mean(abs(gs55 - actual_r90));
  mae4  <- mean(abs(kr4  - actual_r90));
  mae44 <- mean(abs(kr44 - actual_r90));
  mae9  <- mean(abs(kr9  - actual_r90));
  mae69 <- mean(abs(kr69 - actual_r90));
  mae20 <- mean(abs(rr20 - actual_r90));
  maemle <- mean(abs(mle20 - actual_r90));
